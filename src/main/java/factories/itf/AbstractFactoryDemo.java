...
//            Class<?> factory = Class.forName("factories.itf" + factoryName + "Factory");
...
//        }
        ...
        Set<Class<? extends IHotDrinkFactory>> types = new Reflections("factories.itf").getSubTypesOf(IHotDrinkFactory.class);
